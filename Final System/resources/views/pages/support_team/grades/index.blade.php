...
@section('content')
    ...
    <div class="card bg-dark">
        <div class="card-header header-elements-inline bg-dark">
            <h6 class="card-title font-weight-semibold" style="left: 400px; position:relative; ">Manage Grades</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
        ...
        <div class="card-body"bg-image
            ...
            <div class="tab-content">
                    <div class="tab-pane fade show active" id="all-grades">
                        <table class="table datatable-button-html5-columns text-dark">
                            <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Name</th>
