...
@section('content')
    ...
    <div class="card bg-dark">
        <div class="card-header header-elements-inline bg-dark">
            <h6 class="card-title font-weight-semibold" style="left: 400px; position:relative; ">Manage Classes</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
        ...
        <div class="card-body"bg-image
            ...
            <div class="tab-content">
                    <div class="tab-pane fade show active text-dark" id="all-classes">
