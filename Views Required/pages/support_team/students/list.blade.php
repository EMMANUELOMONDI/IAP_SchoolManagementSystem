...
@section('content')
    ...
    <div class="card bg-dark">
        <div class="card-header header-elements-inline bg-dark">
            <h6 class="card-title font-weight-semibold" style="left: 400px; position:relative; ">Students List</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
         ...
         <div class="card-body"bg-image
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active text-dark" id="all-students">
                ...
                @foreach($sections as $se)
                    <div class="tab-pane fade" id="s{{$se->id}}">                         <table class="table datatable-button-html5-columns text-dark">
                            <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Photo</th>
