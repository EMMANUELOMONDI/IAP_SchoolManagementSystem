...
@section('content')
    ...
    <div class="card bg-dark">
        <div class="card-header header-elements-inline bg-dark">
            <h6 class="card-title font-weight-semibold" style="left: 400px; position:relative; ">Manage Subjects</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
         ...
         <div class="card-body"bg-image
            ...
            <div class="tab-content">
                ...
                @foreach($my_classes as $c)
                    <div class="tab-pane fade" id="c{{ $c->id }}">                         <table class="table datatable-button-html5-columns text-dark">
                            <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Name</th>
