...
@section('content')
    ...
    <div class="card bg-dark">
        <div class="card-header header-elements-inline bg-dark">
            <h6 class="card-title" style="position: relative; left: 450px">Manage TimeTables</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
...
>
            ...
            <div class="tab-content">
                   ...
                   <div class="col-md-8">
                       <form class="ajax-store" method="post" action="{{ route('ttr.store') }}">
                           ...
                           <div class="form-group row">
                               <label class="col-lg-3 col-form-label font-weight-semibold text-dark">Name <span class="text-danger">*</span></label>
                               <div class="col-lg-9">
                           ...
                           <div class="form-group row">
                               <label for="my_class_id" class="col-lg-3 col-form-label font-weight-semibold text-dark">Class <span class="text-danger">*</span></label>
                               <div class="col-lg-9">
                           ...
                           <div class="form-group row">
                               <label for="exam_id" class="col-lg-3 col-form-label font-weight-semibold text-dark">Type (Class or Exam)</label>
                               <div class="col-lg-9">
                ...
                @foreach($my_classes as $mc)
                    <div class="tab-pane fade" id="ttr{{ $mc->id }}">                         <table class="table datatable-button-html5-columns text-dark">
                            <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Name</th>
