...
{{-- Reset Promotions --}}
    <div class="card bg-dark">
        <div class="card-header header-elements-inline bg-dark">
            <h5 class="card-title font-weight-semibold" style="left: 100px; position:relative; ">Manage Promotions - Students Who Were Promoted From <span class="text-danger">{{ $old_year }}</span> TO <span class="text-success">{{ $new_year }}</span> Session</h5>
            {!! Qs::getPanelOptions() !!}
        </div>
        ...
        <div class="card-body"bg-image
            ...
            <table id="promotions-list" class="table datatable-button-html5-columns text-dark ">
                <thead>
                <tr>
                    <th>S/N</th>
                    <th>Photo</th>
