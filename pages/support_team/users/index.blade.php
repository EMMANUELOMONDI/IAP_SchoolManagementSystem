...
@section('content')
    ...
    <div class="card bg-dark">
        <div class="card-header header-elements-inline bg-dark">
            <h6 class="card-title" style="position: relative; left: 450px">Manage Users</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
...
>
 ...
 <hr class="divider">                             {{--BLOOD GROUP--}}
                ...
                @foreach($user_types as $ut)
                    <div class="tab-pane fade" id="ut-{{Qs::hash($ut->id)}}">                         <table class="table datatable-button-html5-columns text-dark">
                            <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Photo</th>
